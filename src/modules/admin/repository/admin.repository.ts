...
export class AdminRepository {
  ...
  async getMuscles(locale: string): Promise<MuscleRow[]> {
    return this.queryRows<MuscleRow>(
      `
  ...
  async getEquipments(locale: string): Promise<EquipmentRow[]> {
    return this.queryRows<EquipmentRow>(
      `
  ...
  async getExercises(locale: string): Promise<ExerciseRow[]> {
    return this.queryRows<ExerciseRow>(
      `
